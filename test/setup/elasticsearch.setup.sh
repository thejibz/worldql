...
curl https://raw.githubusercontent.com/thejibz/worldql-core/master/test/setup/wait-for-it.sh --output /tmp/setup/wait-for-it.sh
chmod +x /tmp/setup/wait-for-it.sh
/tmp/setup/wait-for-it.sh localhost:9200 --timeout=30 --strict

# load data in ES
curl https://raw.githubusercontent.com/thejibz/worldql-core/master/test/data/elasticsearch/Employees50K.json --output /tmp/data/Employees50K.json
